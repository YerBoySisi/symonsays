...
public class CreditsScreen extends ClickableScreen implements Runnable{
	...
	public void initAllObjects(List<Visible> viewObjects) {
		...
		viewObjects.add(s);
		ButtonDavid settingsButton = new ButtonDavid(50, 680, 100, Color.WHITE, "Settings", new Action() {
			public void act() {
				Credits.sample.setScreen(Credits.settings);
			}
		});
		viewObjects.add(settingsButton);
		ButtonDavid mainMenuButton = new ButtonDavid(50, 630, 100, 50, "Main Menu", Color.WHITE, new Action() {
			public void act() {
